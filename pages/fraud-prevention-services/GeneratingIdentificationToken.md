...
{: .note }
***API key*** and ***API secret*** can be retrieved by contacting *Mark ID's tech support* or *Mark ID's sales team*:
- sales@Mark ID.com
- info@Mark ID.com
- via Dashboard
...
### Sending request
Send a *HTTP POST* request to: `https://ivs.Mark ID.com/api/v2/token` 
...
|`successUrl`|No|A url where a client will be redirected after a successful verification.|String|<br/>- Min length 5<br/> - Max length 2048<br/> - Cannot be used with [iframe implementation](/pages/verification-service-api/ClientRedirectToWebUiIframe)|`https://ui.Mark ID.com/result?status=success`|
|`errorUrl`|No|A url where a client will be redirected after a failed verification.|String|<br/>- Min length 5<br/> - Max length 2048<br/> - Cannot be used with [iframe implementation](/pages/verification-service-api/ClientRedirectToWebUiIframe)|`https://ui.Mark ID.com/result?status=fail`|
|`unverifiedUrl`|No|A url where a client will be redirected after a not analyzed verification. E.g. user immediately cancels process.|String|<br/>- Min length 5<br/> - Max length 2048<br/> - Cannot be used with [iframe implementation](/pages/verification-service-api/ClientRedirectToWebUiIframe)|`https://ui.Mark ID.com/result?status=unverified`|
...
If you need to increase the maximum default value of the mobile code expiration, please contact sales@Mark ID.com or our technical support team via Dashboard. 
...
{  
   ...
   "firstName":"John Tom",
   "lastName":"Smith",
   "successUrl":"https://www.my-company.com/Mark ID/success",
   "errorUrl":"https://www.my-company.com/Mark ID/fail",
   "unverifiedUrl":"https://www.my-company.com/Mark ID/unverified",
   "callbackUrl" : "https://mywebsite.com/Mark ID/webhookendpoint",
   "locale":"en",
...
Our sales team at sales@Mark ID.com will be happy to answer contract related questions and possibilities of including additional services to your environments.
...
|`reviewSuccessful`|Bool|Indicates if Mark ID's manual review team should review successful verifications after the automatic processing.|
|`reviewFailed`|Bool|Indicates if Mark ID's manual review team should review failed verifications after the automatic processing.|
